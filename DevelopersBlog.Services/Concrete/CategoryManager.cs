...
using DevelopersBlog.Entities.Dtos;
using DevelopersBlog.Services.Abstract;
using DevelopersBlog.Shared.Utilities.Results.Abstract;
using DevelopersBlog.Shared.Utilities.Results.ComplexTypes;
using DevelopersBlog.Shared.Utilities.Results.Concrete;
using System;
...
namespace DevelopersBlog.Services.Concrete
{
    public class CategoryManager : ICategoryService
    {
        ...
        public async Task<IDataResult<CategoryDto>> Update(CategoryUpdateDto categoryUpdateDto, string modifiedByName)
        {
            ...
            return new DataResult<CategoryDto>(ResultStatus.Success, $"{categoryUpdateDto.Name} adlı kategori başarıyle güncellenmiştir.", new CategoryDto 
            {
                Category = updatedCategory,
                ResultStatus = ResultStatus.Success,
                Message = $"{categoryUpdateDto.Name} adlı kategori başarıyle güncellenmiştir."
            });
        }
    }
}
