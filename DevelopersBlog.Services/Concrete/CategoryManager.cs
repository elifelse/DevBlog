...
namespace DevelopersBlog.Services.Concrete
{
    public class CategoryManager : ICategoryService
    {
        ...
        public async Task<IDataResult<Category>> Get(int categoryId)
        {
            ...
            if (category != null)
            {
                return new DataResult<Category>(Shared.Utilities.Results.ComplexTypes.ResultStatus.Success, category);
            }
        ...
        public async Task<IResult> Update(CategoryUpdateDto categoryUpdateDto, string modifiedByName)
        {
            ...
            if (category != null)
            {
                ...
                category.ModifiedDate = DateTime.Now;
                await _unitOfWork.Categories.UpdateAsync(category).ContinueWith(t => _unitOfWork.SaveAsync());
                return new Result(ResultStatus.Success, $"{categoryUpdateDto.Name} adlı kategori başarıyle güncellenmiştir.");
            }
